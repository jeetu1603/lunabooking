...
const Featured = () => {
  const { data, loading, error } = useFetch(
    "/api/hotels/countByCity?cities=delhi,mumbai,chennai"
  );
    ...
    <div className="featured">
      {loading ? (
        ...
        <>
          ...
          <div className="featuredItem">
            <img
              src="https://cf.bstatic.com/xdata/images/city/square250/684667.webp?k=df5960dc1926d569786e9cba95399b2892d6b68b8ad685d33645819443550443&o="
              alt=""
              className="featuredImg"
            />
            <div className="featuredTitles">
